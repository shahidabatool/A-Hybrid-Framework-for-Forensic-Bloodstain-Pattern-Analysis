# ================================================================
# Description:
# This script trains a ConvNeXt-Tiny model for Task 2 (Time Since
# Deposition) forensic bloodstain classification, mapping the five
# aging intervals into three forensic classes.
#
# Objective:
...
#
# Model:
#   ConvNeXt-Tiny (ImageNet pretrained, 3-class classification head)
#
# Training Details:
#   - Optimizer: Adam
...
#
# Output:
#   Best model checkpoint (best_tsd_model_convnext.pth) +
