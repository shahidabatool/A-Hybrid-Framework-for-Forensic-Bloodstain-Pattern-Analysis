# ================================================================
# Description:
# This script trains an EfficientNet-B0 model for Task 2 (Time
# Since Deposition) forensic bloodstain classification, mapping
# the five aging intervals into three forensic classes.
#
# Objective:
...
#
# Model:
#   EfficientNet-B0 (ImageNet pretrained, 3-class classification
#   head)
#
# Training Details:
#   - Optimizer: Adam
...
#
# Output:
#   Best model checkpoint (best_tsd_model_efficientnet.pth) +
...
def main():
    parser = argparse.ArgumentParser(description="Train Task 2 TSD EfficientNet-B0 Model")
    ...
    for epoch in range(epochs):
        ...
        if epoch_val_acc > best_val_acc:
            ...
            best_model_path = os.path.join(args.output_dir, "best_tsd_model_efficientnet.pth")
    ...
    history_df.to_csv(os.path.join(args.output_dir, "tsd_efficientnet_training_history.csv"), index=False)
