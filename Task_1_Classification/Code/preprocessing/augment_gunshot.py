...
CLEANED_DIR = os.path.join(BASE_DIR, "Data", "Cleaned", "Gunshot")
AUGMENTED_DIR = os.path.join(BASE_DIR, "Data", "Augmented")
TRAIN_DST = os.path.join(AUGMENTED_DIR, "train", "Gunshot")
TEST_DST = os.path.join(AUGMENTED_DIR, "test", "Gunshot")
...
def main():
    ...
    if not images:
        print("[!] No cleaned Gunshot images found.")
        return
        
    print(f"Gunshot: splitting and augmenting {len(images)} clean images/tiles...")
    ...
    for pid in test_parents:
        ...
        # Cap the number of test tiles/images from this parent card
    ...
    print(f"  Gunshot Completed: Saved {current_count} train images and {test_count} test images.")
