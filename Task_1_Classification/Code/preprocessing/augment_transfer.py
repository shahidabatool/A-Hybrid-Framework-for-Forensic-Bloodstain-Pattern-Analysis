...
CLEANED_DIR = os.path.join(BASE_DIR, "Data", "Cleaned", "Transfer_Wipe")
AUGMENTED_DIR = os.path.join(BASE_DIR, "Data", "Augmented")
TRAIN_DST = os.path.join(AUGMENTED_DIR, "train", "Transfer_Wipe")
TEST_DST = os.path.join(AUGMENTED_DIR, "test", "Transfer_Wipe")
...
def main():
    ...
    if not images:
        print("[!] No cleaned Transfer Wipe images found.")
        return
        
    print(f"Transfer Wipe: splitting and augmenting {len(images)} clean images...")
    ...
    print(f"  Transfer Wipe Completed: Saved {current_count} train images and {test_count} test images.")
