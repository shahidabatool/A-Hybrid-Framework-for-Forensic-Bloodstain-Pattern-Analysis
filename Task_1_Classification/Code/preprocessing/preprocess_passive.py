...
SRC_DIR = os.path.join(BASE_DIR, "Data", "Organized", "Passive_Drip")
DST_DIR = os.path.join(BASE_DIR, "Data", "Cleaned", "Passive_Drip")
...
def main():
    ...
    print(f"Cleaning Passive Drip: processing {len(images)} images...")
    ...
    print(f"Finished Passive_Drip: {saved_count}/{len(images)} images kept.")
