...
LOCAL_MODEL_PATH = "/content/Models/model2_resnet50.pth"
DRIVE_MODEL_PATH = os.path.join(BASE_DIR, "Models", "model2_resnet50.pth")
...
def evaluate_model():
    ...
    if not os.path.exists(MODEL_PATH):
        ...
        print("Please train the model first on Google Colab and place the weights here.")
        return
    ...
    # Save raw report
    raw_report_path = os.path.join(EVAL_DIR, "resnet50_classification_report.txt")
    with open(raw_report_path, "w") as f:
        f.write("=================================================================\n")
        f.write("  BPA MULTI-TASK RESNET-50 — RAW TEST REPORT\n")
        f.write("=================================================================\n\n")
    ...
    bal_report_path = os.path.join(EVAL_DIR, "resnet50_balanced_classification_report.txt")
    with open(bal_report_path, "w") as f:
        f.write("=================================================================\n")
        f.write("  BPA MULTI-TASK RESNET-50 — BALANCED TEST REPORT\n")
        f.write("=================================================================\n\n")
        f.write("--- Pattern Classification (4 Classes) ---\n")
    ...
    plot_confusion_matrix(cm_p, PATTERN_CLASSES,
                          "ResNet-50: Pattern Confusion Matrix (Raw)",
                          os.path.join(EVAL_DIR, "resnet50_pattern_confusion_matrix.png"),
                          cmap="Blues")
                          
    plot_confusion_matrix(cm_m, MECHANISM_CLASSES,
                          "ResNet-50: Mechanism Confusion Matrix (Raw)",
                          os.path.join(EVAL_DIR, "resnet50_mechanism_confusion_matrix.png"),
                          cmap="Greens")
                          
    plot_multiclass_roc(true_p_raw, probs_p_raw, PATTERN_CLASSES,
                        "ResNet-50: Pattern ROC Curves (Raw)",
                        os.path.join(EVAL_DIR, "resnet50_pattern_roc_auc.png"))
                        
    plot_multiclass_roc(true_m_raw, probs_m_raw, MECHANISM_CLASSES,
                        "ResNet-50: Mechanism ROC Curves (Raw)",
                        os.path.join(EVAL_DIR, "resnet50_mechanism_roc_auc.png"))
                        
    print("\n[+] ResNet-50 evaluation complete!")
